  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97] hover:-translate-y-0.5",
  {
    variants: {
      variant: {
        ...
        sacred: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:opacity-90 shadow-divine font-semibold",
        sacredLight: "bg-background text-foreground hover:bg-background/90 shadow-lg font-semibold",
        ghostLight: "border border-background/30 text-background hover:bg-background/10 font-medium",
      },
      size: {
